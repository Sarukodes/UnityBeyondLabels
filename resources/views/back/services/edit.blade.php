            ...
            <form action="{{ route('admin.services.edit', ['service'=>$service->id]) }}" method="post"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="logo1_title" id="text" class="form-control" value="{{$service->logo1_title}}">
                    </div>
                    <div class="col-md-3">
                        <label for="logo2_text">Text2</label>
                        <input type="text" name="logo2_title" id="text" class="form-control" value="{{$service->logo2_title}}">
                    </div>
                    <div class="col-md-3">
                        <label for="logo3_text">Text3</label>
                        <input type="text" name="logo3_title" id="text" class="form-control" value="{{$service->logo3_title}}">
                    </div>
                    <div class="col-md-3">
                        <label for="logo4_text">Text4</label>
                        <input type="text" name="logo4_title" id="text" class="form-control" value="{{$service->logo4_title}}">
                    </div>
